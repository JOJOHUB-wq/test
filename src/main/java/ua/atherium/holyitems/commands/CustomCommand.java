...
import ua.atherium.holyitems.guis.TrapMaterialSelectorGUI;
import ua.atherium.holyitems.utils.ChatUtil;

public class CustomCommand implements CommandExecutor {
    private final HolyWorldItems plugin;
    public CustomCommand(HolyWorldItems plugin) { this.plugin = plugin; }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        new TrapMaterialSelectorGUI(plugin, (Player) sender).open();
        return true;
    }
}
